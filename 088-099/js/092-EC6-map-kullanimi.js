//! 092-Map Kullanımı | ES6 | JAVASCRIPT Dersleri
...
const map1 = new Map();  //new Map oluşturmak için gereken bir anahtar kelimedir. İleride detaylarıyla anlatılacaktır.
...
//todo kısa hali
// console.log(map1.get(35)) //dönen değeri yakalayıp konsola yazdırmak yerine direkt konsola yazdırıyoruz. 
...
//? HAS : map'in içinde bir değerin olup olmadığını sorgulamak içindir. 
// console.log(map1.has(55)) //key'i 55 olan bir değer var mı ? false
